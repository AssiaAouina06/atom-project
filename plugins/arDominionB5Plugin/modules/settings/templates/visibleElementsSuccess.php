        ...
        <div id="original-collapse" class="accordion-collapse collapse" aria-labelledby="original-heading">
          <div class="accordion-body">
            <?php foreach ([
              ...
              <?php if ($key === 'digital_object_file_name') : ?>
      <?php 
          $fileName = $form[$key]->getValue();
          $titleWithoutExt = $fileName ? pathinfo($fileName, PATHINFO_FILENAME) : '';
          echo render_field($form[$key]->label($titleWithoutExt));
      ?>
  <?php else: ?>
      <?php echo render_field($form[$key]->label($value)); ?>
  <?php endif; ?>
